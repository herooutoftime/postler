...
/* @var $modx modX */
$modx->regClientCSS($postler->config['cssUrl'].'mgr.css');
$modx->regClientStartupScript($postler->config['jsUrl'].'postler.js');
$modx->regClientStartupHTMLBlock('
<script type="text/javascript">
    Ext.onReady(function () {
        postler.config = '.$modx->toJSON($postler->config).';
        postler.config.connector_url = "'.$postler->config['connectorUrl'].'";
    });
</script>');
