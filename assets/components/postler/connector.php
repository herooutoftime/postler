<?php
/**
* Connector file for postler extra
*
...
$postlerCorePath = $modx->getOption('postler.core_path', null, $modx->getOption('core_path') . 'components/postler/');
require_once $postlerCorePath . 'model/postler/postler.class.php';
$modx->postler = new Postler($modx);

$modx->lexicon->load('postler:default');

/* handle request */
$path = $modx->getOption('processorsPath', $modx->postler->config, $postlerCorePath . 'processors/');
