...
Ext.onReady(function() {
    MODx.load({ xtype: 'postler-page-home'});
});

postler.page.Home = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        components: [{
            xtype: 'postler-panel-home'
            ,renderTo: 'postler-panel-home-div'
        }]
    }); 
    postler.page.Home.superclass.constructor.call(this,config);
};
Ext.extend(postler.page.Home,MODx.Component);
Ext.reg('postler-page-home',postler.page.Home);